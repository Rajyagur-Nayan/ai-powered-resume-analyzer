  ...
  return (
    <main className="min-h-screen w-full  flex flex-col items-center px-4 py-8 md:py-16">
      <section className="max-w-5xl w-full text-center space-y-6">
        ...
        >
          An initiative by the <strong>Government of Gujarat</strong> to empower
          citizens by simplifying the grievance redressal process.
        </motion.p>
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <Link href={"/login"}>
            <Button size="lg">File a Complaint</Button>
          </Link>
        </motion.div>
      </section>
      ...
      <section className="mt-16 flex flex-wrap gap-6 max-w-5xl w-full justify-center">
        <Card className="rounded-2xl shadow-md max-w-78">
          <CardContent className="p-6 space-y-4">
            ...
            <p className="text-muted-foreground">
              Every complaint is securely stored and tracked through an
              accountable system.
            </p>
        ...
        <Card className="rounded-2xl shadow-md max-w-78">
          <CardContent className="p-6 space-y-4">
            ...
            <p className="text-muted-foreground">
              Get your issues directly seen by relevant authorities based on
              your location.
            </p>
        ...
        <Card className="rounded-2xl shadow-md max-w-78">
          <CardContent className="p-6 space-y-4">
            ...
            <p className="text-muted-foreground">
              Stay informed with timely email updates about your complaint
              status.
            </p>
      ...
      <section className="mt-24 max-w-4xl text-center">
        ...
        <p className="mt-4 text-muted-foreground">
          We believe in a transparent, responsive and inclusive administration.
          Complaint Kendra is your platform to make your voice heard.
        </p>
        <div className="mt-8">
          <Link href={"/login"}>
